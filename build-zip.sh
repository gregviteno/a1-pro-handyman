...
const roots = [...fs.readdirSync('.').filter(f=>f.endsWith('.html')), 'css/styles.css','css/custom.css','js/main.js','js/tracking.js','contact-handler.php','send-photo.php','.htaccess','robots.txt','sitemap.xml'];
